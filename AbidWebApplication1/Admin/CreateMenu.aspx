<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateMenu.aspx.cs" Inherits="AbidWebApplication1.Admin.CreateMenu" %>
     ...
     <div class="container">
            ...
            <div class="row"> 
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Create Menu</h1>
                    <p>Please enter the new menu details below:</p>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="col-md-6">
            ...
            <p>
                <asp:TextBox ID="TextBoxMtype" runat="server" Height="50px" Width="100%" class="form-control" 
                                            placeholder="MENU TYPE * eg: Starter"></asp:TextBox>&nbsp;

                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                            ControlToValidate="TextBoxMtype" ErrorMessage="*Menue type is required" 
                                            ForeColor="#CC0000"></asp:RequiredFieldValidator>
            </p>   
            

            <p>
                <p>Upload an image of the MENU:</p>
        ...
        <div class="col-md-6">
        <p>
                <asp:TextBox ID="TextBoxMenuDescription" runat="server" Width="100%" class="form-control" 
                                        Height="169px" TextMode="MultiLine" placeholder="Enter MENU'S DESCRIPTION here * "></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                            ControlToValidate="TextBoxMenuDescription" ErrorMessage="*Menu description is required" 
                                            ForeColor="#CC0000"></asp:RequiredFieldValidator>
            ...
            <p>
                <asp:TextBox ID="TextBoxMP" runat="server" Height="50px" Width="100%" class="form-control" 
                                            placeholder="MENU PRICE *  eg: 3.99"></asp:TextBox>&nbsp;

                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                            ControlToValidate="TextBoxMP" ErrorMessage="*Menu's price is required: eg. 4.99" 
                                            ForeColor="#CC0000" Display="Dynamic"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="priceNumber" runat="server" ControlToValidate="TextBoxMP"
                                            
                    ErrorMessage="*Please enter only numbers like 100 or 100.00" 
                    ValidationExpression="^\d+(\.\d\d)?$" Display="Dynamic" ForeColor="#CC0000"></asp:RegularExpressionValidator>
        ...
        <p>
            ...
            <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="CREATE MENU" class="btn btn-xl"/>
