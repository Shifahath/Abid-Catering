<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateVenue.aspx.cs" Inherits="AbidWebApplication1.Admin.CreateVenues" %>
     ...
     <div class="container">
            ...
            <div class="row"> 
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Create VENUE</h1>
                    <p>Please enter the venue details below:</p>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="col-md-6">
            ...
            <p>
                <asp:TextBox ID="TextBoxVN" runat="server" Height="50px" Width="100%" class="form-control" 
                                            placeholder="VENUE NAME *"></asp:TextBox>&nbsp;

                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                            ControlToValidate="TextBoxVN" ErrorMessage="*Venue Name is required" 
                                            ForeColor="#CC0000"></asp:RequiredFieldValidator>
            </p>   
            <p>
                <asp:TextBox ID="TextBoxVL" runat="server" Height="50px" Width="100%" class="form-control" 
                                            placeholder="VENUE LOCATION *  eg: East Ham, London"></asp:TextBox>&nbsp;

                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                            ControlToValidate="TextBoxVL" ErrorMessage="*Venue Location is required: eg. East Ham, London" 
                                            ForeColor="#CC0000"></asp:RequiredFieldValidator>
            </p>  

            <p>
                <p>Upload an image of the VENUE:</p>
        ...
        <div class="col-md-6">
        <p>
                <asp:TextBox ID="TextBoxVenueDescription" runat="server" Width="100%" class="form-control" 
                                        Height="169px" TextMode="MultiLine" placeholder="Enter VENUE'S DESCRIPTION here * "></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                            ControlToValidate="TextBoxVenueDescription" ErrorMessage="*Venue description is required" 
                                            ForeColor="#CC0000"></asp:RequiredFieldValidator>
            ...
            <p>
                <asp:TextBox ID="TextBoxVC" runat="server" Height="50px" Width="100%" class="form-control" 
                                            placeholder="VENUE CAPACITY *  eg: 100"></asp:TextBox>&nbsp;

                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                            ControlToValidate="TextBoxVC" ErrorMessage="*Venue Maximum Capacity is required: eg. 100" 
                                            ForeColor="#CC0000"></asp:RequiredFieldValidator>
            </p> 
        ...
        <p>
            ...
            <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="CREATE VENUE" class="btn btn-xl"/>
