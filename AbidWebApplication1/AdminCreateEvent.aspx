<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminCreateEvent.aspx.cs" Inherits="AbidWebApplication1.AdminCreateEvent" %>
    ...
    <div class="col-lg-12">
        ...
        <p>
                <asp:TextBox ID="TextBoxEventDescription" runat="server" Width="100%" class="form-control" 
                                        Height="198px" TextMode="MultiLine" placeholder="Enter event's description here *"></asp:TextBox>
