<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUsUsers.aspx.cs" Inherits="AbidWebApplication1.AbidUsers.ContactUsUsers" %>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="../AbidUsers/ContactUsUsers.aspx">Contact Us</a></li> 
                        </ul>
     ...
     <div class="container">
             <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <h3 class="section-subheading text-muted">Please give us a brief description of your 
                                event or wedding by sending us a message below.</h3>
                        </div>
    ...
    <div class="col-lg-12">
        ...
        <p>
                <asp:TextBox ID="TextBoxMsg" runat="server" Width="100%" class="form-control" 
                                     ...
                                     <asp:Label ID="MessageLabel" runat="server" ForeColor="white">Message</asp:Label>         
            
                    
        </p>    
        <p>
            <asp:Button ID="btnSendMsg" runat="server" Text="Send Message" 
                 class="btn btn-xl" onclick="btnSendMsg_Click" />
        </p>    
        ...
        <!-- Map -->
    <section class="map" style="margin:0; margin-bottom:0; padding-top:0; padding-bottom:0">
        <iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2476.345814353684!2d-0.7735976999999871!3d51.63519170000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48768a63104efa3f%3A0xd4bce6b89465234e!2s5+Grafton+St%2C+High+Wycombe%2C+Buckinghamshire+HP12+3AJ!5e0!3m2!1sen!2suk!4v1435452444470" style="margin-bottom:0"></iframe>
        
        <small>
            <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2476.345814353684!2d-0.7735976999999871!3d51.63519170000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48768a63104efa3f%3A0xd4bce6b89465234e!2s5+Grafton+St%2C+High+Wycombe%2C+Buckinghamshire+HP12+3AJ!5e0!3m2!1sen!2suk!4v1435452444470"></a>
