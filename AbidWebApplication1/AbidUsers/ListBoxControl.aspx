<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListBoxControl.aspx.cs" Inherits="AbidWebApplication1.AbidUsers.ListBoxControl" %>
...
<div class="row">
   ...
   <%--------------------------------------------- NEXT--------------------------------------------------------%>
    ...
    <div class="col-md-4">
        ...
        <asp:ListView ID="ListViewN" runat="server" DataSourceID="SqlDataSource1">
            ...
            </asp:CheckBoxList> <asp:Label ID="Label3" runat="server" Text='<%# Eval("mPrice") %>'></asp:Label>
